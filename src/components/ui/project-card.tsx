        ...
        <div className="flex items-center gap-4">
          {project.liveUrl && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group/btn relative flex items-center gap-2 px-5 py-2.5 rounded-full bg-black dark:bg-white text-white dark:text-black font-semibold text-sm hover:-translate-y-0.5 transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:shadow-[0_0_15px_rgba(255,255,255,0.2)] hover:shadow-[0_8px_30px_rgb(59,130,246,0.3)] border-none overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500 bg-[length:200%_auto] animate-gradient" />
              <span className="relative flex items-center gap-2 z-10 group-hover/btn:text-white transition-colors duration-300">
