...
export function About() {
      ...
      content: (
        <div>
          ...
          <p className="text-blue-500 font-semibold text-sm mb-4">
            Technical Core Engineer • 6 Months
          </p>
          <p className="text-neutral-600 dark:text-neutral-400 text-base leading-relaxed">
            Completed a comprehensive 6-month internship focused on building robust full-stack web applications using MongoDB, Express.js, React.js, and Node.js.
          </p>
        </div>
      ),
    }
  ...
  return (
    <section id="about">
      <AuroraBackground className="h-auto py-24" showRadialGradient={true}>
